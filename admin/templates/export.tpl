<div id="inserts_all">
  <!-- Вкладки /-->
  <ul id="inserts">
    {if in_array('Import', $user_allowed)}<li><a href="index.php?section=Import" class="off">импорт</a></li>{/if}
      ...
      <div id="cont_center">
        ...
        {/if}
           ...
           <FORM name=import METHOD=POST enctype='multipart/form-data'>
					...
					<input type="checkbox" name="yandex_export" value="true" /> Export to Yandex Market<br />
