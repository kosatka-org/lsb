  ...
  <div id="cont_border">
    <div id="cont">
      ...
      <div id="cont_top">
	    ...
	    <!-- Заголовок раздела /-->
        <h1 id="headline">Цвета</h1>
        <!-- /Заголовок раздела /-->
        
		 <!-- Помощь2 /-->
        <div class="help2">
            <a href='index.php?section=Color&token={$Token}' class="fl"><img src="./images/add.jpg" alt="" class="fl"/>Добавить цвет</a>
        </div>
        <!-- /Помощь2 /-->
      </div>
...
<!--                      <p>
          ...
          <!-- Форма Товаров #End /-->
          {else}
            <div class="emptylist">Нет цветов</div>
          {/if}
