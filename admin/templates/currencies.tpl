...
<div id="content">
  ...
  {if $Items}						
							<table>
								<tr>
								  <td></td>
									<td class="small_text" style="max-width:200px;">Название</td>
									<td class="small_text" style="max-width:200px;">Eng.name</td>
     ...
     {foreach item=item from=$Items}
								<tr>
									...
									<td class="td_padding">
									  <input type="text" class="input4" style="width: 180px;" name=names[{$item->currency_id}] value='{$item->name|escape}'/>
									</td>
									<td class="td_padding">
									  <input type="text" class="input4" style="width: 180px;" name=eng_names[{$item->currency_id}] value='{$item->eng_name|escape}'/>
									</td>
									<td class="td_padding">
...
<form method=post>
							...
							<table>
								<tr>
									...
									<td class="small_text">Eng.name</td>
									<td class="small_text">Знак</td>
									<td class="small_text">Код ISO</td>
									<td class="small_text" colspan=2  style='padding-left:20px;'>Курс</td>
									<td></td>
								...
								<tr>
									<td class="td_padding">
									  <input type="text" class="input4" style="width: 180px;" name='name' />
									</td>
									<td class="td_padding">
									  <input type="text" class="input4" style="width: 180px;" name='eng_name' />
									</td>
									<td class="td_padding">
