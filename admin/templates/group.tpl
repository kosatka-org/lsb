    ...
    <div id="cont">
      ...
      <div id="cont_center">
        ...
        <!-- Форма товара #Begin /-->
                ...
                <tr>
									<td class="model">Показывать все товары в каталоге</td>
									<td class="model"><p><input name="show_all_products" type="checkbox" class="checkbox" {if $Group->show_all_products}checked{/if} value='1'/>
									</p></td>
								</tr>
							</table>
