<script language="javascript" type="text/javascript" src="../third_party/js/tiny_mce/plugins/smimage/smplugins.js"></script>
<script language="javascript" type="text/javascript" src="../third_party/js/tiny_mce/tiny_mce.js"></script>
<script language="javascript">
  ...
  tinyMCE.init({literal}{{/literal}
    ...
    content_css :"../design/"+theme+"/css/style.css?v=1",
