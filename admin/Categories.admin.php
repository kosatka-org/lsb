...
class Categories extends Widget
{
  ...
  function fetch() {
	...
	$params = array();
	if ( isset($_GET['with_seo']) ) {
		$params['with_seo'] = true;
	}
    $categories = Storefront::get_categories(0, $params);
    $params['canonical'] = true;
    $canonical_categories = Storefront::get_categories(0, $params);
    // exit(var_dump($canonical_categories));
