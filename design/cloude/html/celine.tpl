...
<div class="ShAA_mainBerluti" style="max-width: 100%;">
	<div class="ShAA_berlutiBannerBig" style="position: relative;">
        <div>
            <a href="/brands/celine/" title="Фирменный бутик одежды обуви сумок и аксессуаров бренда Celine">
                <img src="/design/adaptive/images/celine_1.jpg" alt="Фирменный бутик одежды обуви сумок и аксессуаров бренда Celine" style="float: left;"/>
            </a>
        </div>
    ...
    <div class="ShAA_instaBlock">
        <div id="instafeed">
            ...
            <!-- LightWidget WIDGET --><script src="//lightwidget.com/widgets/lightwidget.js"></script><iframe src="//lightwidget.com/widgets/78a37d4773a05d39b19efff73dc80269.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width: 100%; border: 0; overflow: hidden;"></iframe>
        </div>
    </div>
    <div class="ShAA_textBlockGray">
        <div class="ShAA_textBlockInner">
            <div class="ShAA_srTitle">Celine</div>
            <div class="ShAA_srTextDiv ShAA_srLineUnderTitle">
            </div>
            <div class="ShAA_srTextDiv">
                Celine - французский Дом моды, который создает одежду, обувь, сумки и аксессуары, подходящие для деловых и энергичных женщин.
            </div>
            <div class="ShAA_srTextDiv">
                Дизайнеры бренда отдают предпочтение лаконичности, оригинальному крою и сдержанной цветовой палитре.
            </div>
            <div class="ShAA_srTextDiv">
    ...
    <div id="gallery" style="display:none; clear: both;">
        <img alt="Celine" src="/design/adaptive/images/celine_2.jpg" data-image="/design/adaptive/images/celine_2.jpg" data-description="Celine"/>
