...
<div style="float: left;margin: 0 10px 0 0;">
	...
	{else}
		<img id="zoom1" src="{$product->image}" style="float: left;width: 180px;" />
	{/if}
								
	<div style="line-height: 32px;float: left;margin-left:22px;max-width:395px;width: auto;">
		<div style="float: left;margin: 25px 0 0 0; width: 100%;"></div>
			{if $product->p_date}
...
<div style="width:230px;float:right;display: none !important;">
