...
{/literal}
					...
					<div id="client_search_add">
						...
						<div class="ShAA_popData ShAA_popDataSett">
							...
							<div class="ShAA_popInput ShAA_person phone" style="float: left; margin-right: 8px; width: 100%;">
								<input type="text" name="client_info" id="client_info" value=""  style="width: 94%;"/>
							</div>
							<div class="ShAA_popInfoInput">
								пример: 9206003322, name@mail.com или Иванов Петр Сергеевич
							</div>
							<div style="float: left; width: 100%;">
								<a href="#" style="width: 100%;" onclick="{literal}jQuery('.ShAA_popResult').load('/index.php?module=Cart&client_find&search='+jQuery('#client_info').eq(0).val().replace(/ /g, '+'));return false;{/literal}">
									<input style="padding: 12px 0;" class="ShAA_popButton_input" value="Найти" />
								</a>
								<a href="#" style="width: 100%; padding: 12px 0; margin: 24px 0 0 0;" onclick="{literal}jQuery('#client_add_div').show();jQuery('#client_search_add').hide();{/literal}" class="ShAA_popButton notUnderline" style="margin:0px;">
									Добавить клиента
								</a>
							</div>
							<div class="clear"></div>
					...
					<div id="client_add_div" style="display: none; clear: both; margin-top: 30px; float: left;">
						...
						<div style="margin: 32px 0 0 0;">
							...
							<a style="margin: 12px 0px; float: left;" onclick="{literal}jQuery('#client_add_div').hide();jQuery('#client_search_add').show();{/literal}">Отменить</a>
						</div>
					</div>
					...
					<div style="margin: 32px 0 0 0; clear: both; float: left; width: 100%;">
						<input type="submit" value="Заказать услугу" class="ShAA_popButton_input" onclick="jQuery('#service_add').submit();return false;">
						<a onclick="{literal}jQuery.fancybox.close();{/literal}" style="margin: 12px 0px; float: left;">Отменить</a>
					</div>
				</form>
                <div class="clear"></div>
                <div class="ShAA_popMiniInfo" style="margin: 12px 0;">Нажимая на кнопку "Сохранить", вы даете <a href="/sections/personal_data">согласие на обработку персональных данных</a></div>
			</div>
		</div>
	</div>
	<div class="clear"></div>
