...
<atom:link href="/index.php?module=Rss" rel="self" type="application/rss+xml" />
...
<item>
  ...
  <description>{$item->anons}{$item->text}</description>
 
  {*<comments>http://anton.example.com/post100.html#comments</comments>*}
</item>
{/foreach}
