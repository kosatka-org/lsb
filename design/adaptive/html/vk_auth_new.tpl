...
<form autocomplete="off" action="/" method="get" name="form_discount1" id="form_discount1" enctype="multipart/form-data">
			<div class="sett1">
				<div class="ShAA_pop_title">Пожалуйста, зарегистрируйтесь как пользователь популярных соцсетей</div>
				{literal}
				...
				<div style="margin: 24px 0 0 0;" class="ShAA_pop_title">или заполните форму</div>
				<div>
					...
					<div class="ShAA_settingRightBlock">
						<div class="ShAA_popData ShAA_popDataSett">
							...
							<div class="ShAA_popInput phone">
								<span class="ShAA_prefixForMiniInput">+7</span><input placeholder="XXXXXXXXXX" type="text" name="phone_number" id="phone_number" {literal}class="validate[required,custom[phone]],custom[number]"{/literal} value=""/>
							</div>
							<div class="ShAA_popInfoInput">
								пример: 9206003322
							</div>
				...
				<div style="float: left; margin: 20px 0 16px 0; width: 100%;">
					...
					<a href="javascript:void(0);" onclick="jQuery('#form_discount1').submit();return false;">				
						<div class="ShAA_popButton">Зарегистрироваться</div>
					</a>
