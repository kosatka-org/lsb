...
<div class="ShAA_mainBerluti" style="max-width: 100%;">
	<div class="ShAA_berlutiBannerBig" style="position: relative;">
        <div>
            <a href="/catalog/?category=furs&sex=2" title="Бутик итальянских мехов">
                <img src="/design/adaptive/images/show_furs_top_banner.jpg" alt="Бутик фирменной одежды из Италии и Франции" style="float: left;"/>
            </a>
        </div>
        <div class="ShAA_overlay"></div>
        <div class="ShAA_srTextOnBanner">
            <div>
                <a href="/subscription/fur_subscribe/" id="feedbackbox"  onclick="{literal}rG('BRAND_SUBSCRIBE');{/literal}">
            ...
            В наличии более 500 моделей разнообразных оттенков и фасонов. </br>
    ...
    <div class="ShAA_instaBlock">
        <div id="instafeed">
            ...
            <!-- LightWidget WIDGET --><script src="//lightwidget.com/widgets/lightwidget.js"></script><iframe src="//lightwidget.com/widgets/86916fceefd054e794b561851c9c07d8.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width: 100%; border: 0; overflow: hidden;"></iframe>
        </div>
    </div>
    <div class="ShAA_textBlockGray">
        <div class="ShAA_textBlockInner">
            <div class="ShAA_srTitle">Итальянские меха</div>
    ...
    <div id="gallery" style="display:none; clear: both;">
        <img alt="Итальянские меха" src="/design/adaptive/images/showfurs_2.jpg" data-image="/design/adaptive/images/showfurs_2.jpg" data-description="Итальянские меха"/>
