...
<head>
	...
	<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,600&subset=latin,cyrillic-ext,cyrillic' rel='stylesheet' type='text/css'>
	...
	<div class="ShAA_middleBlock">
		...
		<div class="contents">
			<div class="ShAA_info">
				...
				специальные цены на одежду и обувь {foreach from=$item->brands name="brands" item="brand"}<a href="/brands/{$brand->url}/" target="_blank">{$brand->name}</a>{if !$smarty.foreach.brands.last && $smarty.foreach.brands.total > 1},{/if}{if $smarty.foreach.brands.first}<br>{/if}{/foreach}<br>
				Только в эти выходные по специальной цене.<br>
				Следите за нами по хеш тэгу #СВД<br>
				в <a href="http://instagram.com/lsboutique.ru" target="_blank">Instagram</a>, <a href="https://plus.google.com/+LsboutiqueRu/posts" target="_blank">Google+</a>, <a href="https://www.facebook.com/lsboutiq" target="_blank">Facebook</a>, <a href="http://vk.com/lsboutiq" target="_blank">Vkontakte</a>.
