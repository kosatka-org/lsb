 ...
 */
 (function($) {
	 ...
	 var methods = {
		...
		*/
		_buildPrompt: function(field, promptText, type, ajaxed, options) {
			field.addClass("ShAA_errorRedBorder");
		...
		*/
		 _closePrompt: function(field) {
			 ...
			 field.removeClass("ShAA_errorRedBorder");
	...
	$.validationEngine= {fieldIdCounter: 0,defaults:{
		...
		// defaultBottom, topRight, bottomLeft, centerRight, bottomRight
		promptPosition: "defaultBottom",
		bindMethod:"bind",
